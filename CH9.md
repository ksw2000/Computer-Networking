...
+ VoIP 封包只有在用戶有通話時才會傳送資料，不講話他就不傳免的浪費流量

### Adaptive playout delay

goal: useful to estimate average deviation of delay
...
+ each TRCP packet contains sender and/or receiver repots
...
1. Average rete. The network may wish to limit the long-term average rate
